    ...
    <div style={{ marginBottom: 16 }}>
      ...
      <div style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
        ...
        <input
          ...
          onBlur={(e) => {
            e.target.style.borderColor = error ? 'rgba(239,68,68,0.5)' : 'rgba(37,99,235,0.22)'
      ...
      {error && <p style={{ fontSize: 12, color: '#ef4444', marginTop: 5, fontFamily: 'Inter, sans-serif' }}>{error}</p>}
      {helper && !error && <p style={{ fontSize: 12, color: '#64748B', marginTop: 5, fontFamily: 'Inter, sans-serif' }}>{helper}</p>}
    </div>
  )
}
