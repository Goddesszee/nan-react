...
function doList(){
  ...
  openBillModal('List Your Service', `
    <div style="display:flex;flex-direction:column;gap:3px;">
      ...
      <button onclick="submitListService()" id="listBtn" style="width:100%;background:#7000ff;border:none;border-radius:14px;color:#fff;padding:15px;font-size:1rem;font-weight:700;cursor:pointer;font-family:'Inter',sans-serif;">Create Payment Link</button>
...
async function verifyNepaMeter(){
  ...
  document.getElementById('nepaVerifyResult').innerHTML = `
    ...
    <button onclick="submitNepa()" id="nepaSubmitBtn" style="width:100%;background:#7000ff;border:none;border-radius:14px;color:#fff;padding:15px;font-size:1rem;font-weight:700;cursor:pointer;">Pay Electricity Bill</button>
...
async function verifyDstvCard(){
  ...
  document.getElementById('dstvVerifyResult').innerHTML = `
    ...
    <button onclick="submitDstv()" id="dstvSubmitBtn" style="width:100%;background:#7000ff;border:none;border-radius:14px;color:#fff;padding:15px;font-size:1rem;font-weight:700;cursor:pointer;">Subscribe</button>
...
function _ensureAIButton(){
  ...
  if(btn){
    ...
    btn.style.cssText='position:fixed!important;bottom:88px!important;right:18px!important;z-index:10000!important;width:52px!important;height:52px!important;border-radius:50%!important;background:#6d28d9!important;border:none!important;cursor:pointer!important;display:flex!important;align-items:center!important;justify-content:center!important;box-shadow:0 4px 20px rgba(109,40,217,.5)!important;';
